...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendData = channel.unary_unary(
                '/greet.Greeter/SendData',
                request_serializer=greet__pb2.DataRequest.SerializeToString,
                response_deserializer=greet__pb2.DataReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendData,
                    request_deserializer=greet__pb2.DataRequest.FromString,
                    response_serializer=greet__pb2.DataReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def SendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/greet.Greeter/SendData',
            greet__pb2.DataRequest.SerializeToString,
            greet__pb2.DataReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
